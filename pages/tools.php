...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
				...
				<section class="content col-md-6 col-sm-12">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#admin" data-toggle="tab" aria-expanded="true" class="cust-label">List of Tools</a></li>
						</ul>
								...
								<div class="row">
									<div class="col-md-8 col-xs-12">
										<div class="form-group">
											<input id="txtSearchTools" class="form-control input-sm cust-label" type="text" placeholder="Search tools here...">
										</div>
									</div>
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnAddTools" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
									...
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnExportTools" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
								...
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="table-container">
											<table id="tblTools" name="tblTools" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
												<thead>
													<tr>
														<th>Tool Name</th>
														<th>Description</th>
		...
		<!-- Tools Modal  -->
		<div class="modal fade" id="mdTools" name="mdTools" data-backdrop="static" data-keyboard="false">
			<div class="modal-dialog modal-md">
				<div class="box box-default">
					<div class="box-header with-border">
						<label class="cust-label">Tools Details</label>
					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-12">
							   <center>
								   <img id="imgProfile" alt="User Image"
								   onerror="this.onerror=null; this.src='./../photos/tools/default.png'" style="
									height:200px;
									max-height:200px;
									object-fit: cover;
						 ...
						 <div class="row">
							<div class="col-md-12">
							   <center>
								  <a href="#" class="cust-label" onclick="openImage()">Upload Inmage</a>
							   </center>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									<label class="cust-label">Tool Name *</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtToolName" name="txtToolName" placeholder="Enter Tool Name">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									...
									<textarea id="txtDescription" class="form-control cust-label cust-textbox" rows="3" placeholder="Enter Description...."></textarea>
								</div>
							</div>
						</div>
					</div>
					<div class="box-footer">
						<div class="row">
							...
							<div class="col-sm-6">
								<button id="btnDelete" type="button" class="btn btn-block btn-danger btn-sm cust-textbox">
		...
		<script src="../program_assets/js/web_functions/tools.js?random=<?php echo uniqid(); ?>"></script>
