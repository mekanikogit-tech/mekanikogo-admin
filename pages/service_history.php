...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
				...
				<section class="content col-md-10 col-sm-12">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#admin" data-toggle="tab" aria-expanded="true" class="cust-label">List of Service Requests</a></li>
						</ul>
								...
								<div class="row">
									<div class="col-md-4 col-xs-12">
										<div class="form-group">
											<input id="txtSearchHistory" class="form-control input-sm cust-label" type="text" placeholder="Search history here...">
										</div>
									</div>
								
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<select id="ddlStatusFilter" class="form-control input-sm cust-label">
									...
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<input id="dateRequested" type="date" class="form-control input-sm cust-label" placeholder="Date Requested">
										</div>
									</div>
								
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnGenerateReport" type="button" class="btn btn-block btn-success btn-sm cust-textbox">
									...
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnExportReport" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
								...
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="table-container">
											<table id="tblHistory" name="tblHistory" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
												<thead>
													<tr>
														<th>Customer Name</th>
														<th>Concern</th>
		...
		<script src="../program_assets/js/web_functions/service_history.js?random=<?php echo uniqid(); ?>"></script>
