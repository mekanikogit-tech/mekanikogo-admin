...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
							...
							<div class="tab-pane active" id="admin">
								<div class="row">
									...
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnAddAccount" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
		...
		<!-- Account Modal  -->
		<div class="modal fade" id="mdAccount" name="mdAccount">
			<div class="modal-dialog modal-md">
				<div class="box box-default">
					<div class="box-header with-border">
						<label class="cust-label">Admin Account Form</label>
					...
					<div class="box-body">
						...
						<div class="row">
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control cust-label cust-textbox" id="txtFirstName" name="txtFirstName" placeholder="">
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<label class="cust-label text-danger">*</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtLastName" name="txtLastName" placeholder="">
								</div>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Mobile (09xxxxxxxxx)</label>
									<label class="cust-label text-danger">*</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtMobileNumber" name="txtMobileNumber" placeholder="" maxlength="11" onkeyup="numOnly(this)">
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<label class="cust-label text-danger">*</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtEmailAddress" name="txtEmailAddress" placeholder="">
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<label class="cust-label text-danger">*</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtUsername" name="txtUsername" placeholder="">
								</div>
							</div>
						</div>
					</div>
					<div class="box-footer">
						<div class="row">
							...
							<div class="col-md-4 col-xs-12">
								<button id="btnSaveUser" type="button" class="btn btn-block btn-primary btn-sm cust-textbox">
		...
		<script src="../program_assets/js/web_functions/admin_registration.js?random=<?php echo uniqid(); ?>"></script>
