...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
				...
				<section class="content col-md-8 col-sm-12">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#admin" data-toggle="tab" aria-expanded="true" class="cust-label">List of Accounts</a></li>
						</ul>
		...
		<!-- Account Modal  -->
		<div class="modal fade" id="mdAccount" name="mdAccount" data-backdrop="static" data-keyboard="false">
			<div class="modal-dialog modal-md">
				<div class="box box-default">
					<div class="box-header with-border">
						<label class="cust-label">Drivers Details</label>
						<button type="submit" class="btn btn-default btn-xs pull-right" data-dismiss="modal">
					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-12">
								<span class="pull-right-container">
									<small class="label pull-left bg-gray">Basic Information</small>
								</span>
							</div>
						</div>
						<br>
						<div class="row">
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control cust-label cust-textbox" id="txtFirstName" name="txtFirstName" placeholder="" disabled>
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control cust-label cust-textbox" id="txtLastName" name="txtLastName" placeholder="" disabled>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label class="cust-label">Full Address</label>
									<textarea id="txtFullAddress" class="form-control cust-label cust-textbox" rows="3" placeholder="" disabled></textarea>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Car Type</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtCarType" name="txtCarType" placeholder="" disabled>
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Plate Number</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtPlateNumber" name="txtPlateNumber" placeholder="" disabled>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<span class="pull-right-container">
									<small class="label pull-left bg-gray">Login Credentials</small>
								</span>
							</div>
						</div>
						<br>
						<div class="row">
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control cust-label cust-textbox" id="txtMobileNumber" name="txtMobileNumber" placeholder="" disabled>
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Email</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtEmailAddress" name="txtEmailAddress" placeholder="" disabled>
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Username</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtUsername" name="txtUsername" placeholder="" disabled>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<span class="pull-right-container">
									<small class="label pull-left bg-gray">Attached Documents</small>
								</span>
							</div>
						</div>
						<br>
						<div class="row">
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Drivers License</label>
									<br>
									<img id="img1" src="" class="img-rounded clickable-image" alt="Image" data-target="#lightbox">
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Vehicle Official Receipt</label>
									<br>
									<img id="img2" src="" class="img-rounded clickable-image" alt="Image" data-target="#lightbox">
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Certificate of Registration</label>
									<br>
									<img id="img3" src="" class="img-rounded clickable-image" alt="Image" data-target="#lightbox">
								</div>
							</div>
						</div>
					</div>
					<div class="box-footer">
						<div class="row">
							<div class="col-md-12">
								<span class="pull-right-container">
									<small class="label pull-left bg-gray">Message from Admin</small>
								</span>
							</div>
						</div>
						<br>
						<div class="row">
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control cust-label cust-textbox" id="txtTitle" name="txtTitle" placeholder="" disabled>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea id="txtMessage" class="form-control cust-label cust-textbox" rows="3" placeholder=""></textarea>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<code class="cust-label">You can add your own custom message or use the default</code>
							</div>
						</div>
						<br>
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<select id="cmbAccountStatus" name="cmbAccountStatus" class="form-control select2 cust-label cust-textbox" style="width: 100%;">
							...
							<div class="col-md-4 col-sm-12">
								<button id="btnSaveChanges" type="button" class="btn btn-block btn-primary btn-sm cust-textbox">
		...
		<script src="../program_assets/js/web_functions/drivers_approval.js?random=<?php echo uniqid(); ?>"></script>
