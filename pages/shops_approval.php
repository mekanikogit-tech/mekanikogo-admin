...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
			...
			<div class="modal-dialog modal-lg">
				<div class="box box-default">
					<div class="box-header with-border">
						<label class="cust-label">Shop Owner Details</label>
						...
						<div class="row">
						  <div class="col-md-6 col-sm-12">
							...
							<div class="row">
							  <div class="col-md-6 col-sm-12">
								<div class="form-group">
								  <label class="cust-label">Owner's Name</label>
								  <input type="text" class="form-control cust-label cust-textbox" id="txtOwnersName" name="txtOwnersName" disabled>
								</div>
							  </div>
							  <div class="col-md-6 col-sm-12">
								<div class="form-group">
								  <label class="cust-label">Shop Name</label>
								  <input type="text" class="form-control cust-label cust-textbox" id="txtShopName" name="txtShopName" disabled>
								</div>
							  </div>
							</div>
							...
							<div class="row">
							  <div class="col-md-6 col-sm-12">
								<div class="form-group">
								  ...
								  <input type="text" class="form-control cust-label cust-textbox" id="txtContactNumber" name="txtContactNumber" disabled>
								</div>
							  </div>
							  <div class="col-md-6 col-sm-12">
								<div class="form-group">
								  <label class="cust-label">Schedule</label>
								  <input type="text" class="form-control cust-label cust-textbox" id="txtSchedule" name="txtSchedule" disabled>
								</div>
							  </div>
							</div>
							...
							<div class="row">
							  <div class="col-md-6 col-sm-12">
								<div class="form-group">
								  <label class="cust-label">Business Hours</label>
								  <input type="text" class="form-control cust-label cust-textbox" id="txtBusinessHours" name="txtBusinessHours" disabled>
								</div>
							  </div>
							  <div class="col-md-6 col-sm-12">
								<div class="form-group">
						  ...
						  <div class="col-md-6 col-sm-12">
							...
							<label class="cust-label">Shop Location</label>
							<iframe
							  id="shopMap"
							  width="100%"
							  height="350"
					...
					<div class="box-footer">
						<div class="row">
							...
							<div class="col-md-4">
								<button id="btnDeleteAccount" type="button" class="btn btn-block btn-danger btn-sm cust-textbox">
		...
		<script src="../program_assets/js/web_functions/shops_approval.js?random=<?php echo uniqid(); ?>"></script>
