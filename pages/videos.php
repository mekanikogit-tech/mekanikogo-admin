...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
								...
								<div class="row">
									<div class="col-md-8 col-xs-12">
										<div class="form-group">
											<input id="txtSearchTools" class="form-control input-sm cust-label" type="text" placeholder="Search videos here...">
										</div>
									</div>
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnAddVideo" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
									...
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnExportVideo" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
								...
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="table-container">
											<table id="tblVideo" name="tblVideo" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
												<thead>
													<tr>
														<th>Title</th>
														<th>Link</th>
		...
		<!-- Tools Modal  -->
		<div class="modal fade" id="mdVideo" name="mdVideo" data-backdrop="static" data-keyboard="false">
			<div class="modal-dialog modal-md">
				<div class="box box-default">
					<div class="box-header with-border">
						<label class="cust-label">Video Details</label>
					...
					<div class="box-body">
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									<label class="cust-label">Video Name *</label>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									<label class="cust-label">Link *</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtLink" name="txtLink" placeholder="Enter Link">
								</div>
							</div>
						</div>
					</div>
		...
		<script src="../program_assets/js/web_functions/videos.js?random=<?php echo uniqid(); ?>"></script>
